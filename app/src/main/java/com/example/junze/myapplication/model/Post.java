...
public class Post {
    ...
    public Post(Member member, Node node, int id, String title, String url, String content, String content_rendered, int replies, int created, int last_modified, int last_touched) {
        this.member = member;
        this.node = node;
        this.id = id;
        this.title = title;
